...
def main():
    ...
    files.sort(key=lambda p: os.stat(p).st_mtime, reverse=True)   # reverse=True: dal file più recentemente modificato al più remoto, come richiesto da questo enunciato
